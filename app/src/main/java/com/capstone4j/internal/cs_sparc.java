...
public class cs_sparc {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, cs_sparc_op.layout()).withName("operands")
    ).withName("cs_sparc");
    ...
    private static final long hint$OFFSET = 4;
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_sparc_op.layout().byteSize());
    }
