...
public class cs_tricore_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            tricore_op_mem.layout().withName("mem")
        ).withName("$anon$40:2"),
        capstone_h.C_CHAR.withName("access"),
        MemoryLayout.paddingLayout(7)
    ).withName("cs_tricore_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$40:2"), groupElement("reg"));
    ...
    private static final OfLong imm$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$40:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$40:2"), groupElement("mem"));
