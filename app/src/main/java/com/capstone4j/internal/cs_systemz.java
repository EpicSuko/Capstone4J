 ...
 * struct cs_systemz {
 *     systemz_cc cc;
 *     systemz_insn_form format;
 *     uint8_t op_count;
 *     cs_systemz_op operands[6];
 * }
 * }
 */
public class cs_systemz {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(6, cs_systemz_op.layout()).withName("operands")
    ).withName("cs_systemz");
    ...
    private static final long op_count$OFFSET = 8;
    ...
    private static final long operands$OFFSET = 16;
    ...
    private static long[] operands$DIMS = { 6 };
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_systemz_op.layout().byteSize());
    }
