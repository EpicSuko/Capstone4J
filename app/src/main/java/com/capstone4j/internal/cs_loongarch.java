 ...
 *     uint8_t op_count;
 *     cs_loongarch_op operands[8];
 * }
 * }
 */
public class cs_loongarch {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(8, cs_loongarch_op.layout()).withName("operands")
    ).withName("cs_loongarch");
    ...
    private static final long op_count$OFFSET = 4;
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_loongarch_op.layout().byteSize());
    }
