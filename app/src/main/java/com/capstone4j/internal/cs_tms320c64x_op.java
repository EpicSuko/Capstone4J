...
public class cs_tms320c64x_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            tms320c64x_op_mem.layout().withName("mem")
        ).withName("$anon$58:2")
    ).withName("cs_tms320c64x_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$58:2"), groupElement("reg"));
    ...
    private static final OfInt imm$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$58:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$58:2"), groupElement("mem"));
