 ...
 * struct cs_xtensa {
 *     uint8_t op_count;
 *     cs_xtensa_op operands[8];
 *     xtensa_insn_form format;
 * }
 * }
 */
public class cs_xtensa {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(8, cs_xtensa_operand.layout()).withName("operands"),
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_xtensa_operand.layout().byteSize());
    }
    ...
    private static final long format$OFFSET = 100;
