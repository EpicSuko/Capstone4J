...
public class cs_riscv {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        capstone_h.C_BOOL.withName("need_effective_addr"),
        capstone_h.C_CHAR.withName("op_count"),
        MemoryLayout.paddingLayout(6),
        MemoryLayout.sequenceLayout(8, cs_riscv_op.layout()).withName("operands")
    ).withName("cs_riscv");
    ...
    private static final OfBoolean need_effective_addr$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("need_effective_addr"));
     ...
     * }
     */
    public static final OfBoolean need_effective_addr$layout() {
        return need_effective_addr$LAYOUT;
    }

    private static final long need_effective_addr$OFFSET = 0;
     ...
     * }
     */
    public static final long need_effective_addr$offset() {
        return need_effective_addr$OFFSET;
    }
     ...
     * }
     */
    public static boolean need_effective_addr(MemorySegment struct) {
        return struct.get(need_effective_addr$LAYOUT, need_effective_addr$OFFSET);
    }
     ...
     * }
     */
    public static void need_effective_addr(MemorySegment struct, boolean fieldValue) {
        struct.set(need_effective_addr$LAYOUT, need_effective_addr$OFFSET, fieldValue);
    }
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_riscv_op.layout().byteSize());
    }
