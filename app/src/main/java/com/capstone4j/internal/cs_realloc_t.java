...
/**
 * {@snippet lang=c :
 * typedef void *(*cs_realloc_t)(void *, size_t) __attribute__((cdecl))
 * }
 */
public class cs_realloc_t {
    ...
    private static final MethodHandle UP$MH = capstone_h.upcallHandle(cs_realloc_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(cs_realloc_t.Function fi, Arena arena) {
