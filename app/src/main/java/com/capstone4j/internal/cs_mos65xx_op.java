...
public class cs_mos65xx_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            capstone_h.C_INT.withName("mem")
        ).withName("$anon$183:2")
    ).withName("cs_mos65xx_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$183:2"), groupElement("reg"));
    ...
    private static final OfShort imm$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$183:2"), groupElement("imm"));
     ...
     * }
     */
    public static short imm(MemorySegment struct) {
     ...
     * }
     */
    public static void imm(MemorySegment struct, short fieldValue) {
        struct.set(imm$LAYOUT, imm$OFFSET, fieldValue);
    }

    private static final OfInt mem$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$183:2"), groupElement("mem"));
     ...
     * }
     */
    public static final OfInt mem$layout() {
        return mem$LAYOUT;
    }
     ...
     * }
     */
    public static int mem(MemorySegment struct) {
     ...
     * }
     */
    public static void mem(MemorySegment struct, int fieldValue) {
