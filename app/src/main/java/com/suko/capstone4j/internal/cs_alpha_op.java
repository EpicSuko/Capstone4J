...
public class cs_alpha_op {
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$34:2"), groupElement("reg"));
    ...
    private static final OfInt imm$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$34:2"), groupElement("imm"));
