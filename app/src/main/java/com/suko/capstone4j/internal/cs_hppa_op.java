...
public class cs_hppa_op {
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$480:2"), groupElement("reg"));
    ...
    private static final OfLong imm$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$480:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$480:2"), groupElement("mem"));
