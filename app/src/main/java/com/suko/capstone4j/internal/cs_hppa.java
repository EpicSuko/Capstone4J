 ...
 * struct cs_hppa {
 *     uint8_t op_count;
 *     cs_hppa_op operands[5];
 * }
 * }
 */
public class cs_hppa {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(5, cs_hppa_op.layout()).withName("operands")
    ).withName("cs_hppa");
    ...
    private static long[] operands$DIMS = { 5 };
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_hppa_op.layout().byteSize());
    }
