...
public class cs_mips {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(10, cs_mips_op.layout()).withName("operands")
    ).withName("cs_mips");
    ...
    private static long[] operands$DIMS = { 10 };
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_mips_op.layout().byteSize());
    }
