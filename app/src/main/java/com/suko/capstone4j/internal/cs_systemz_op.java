...
/**
 * {@snippet lang=c :
 * struct cs_systemz_op {
 *     systemz_op_type type;
 *     union {
 *         systemz_reg reg;
 *         int64_t imm;
 *         systemz_op_mem mem;
...
public class cs_systemz_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            systemz_op_mem.layout().withName("mem")
        ).withName("$anon$368:2"),
        capstone_h.C_INT.withName("access"),
        capstone_h.C_CHAR.withName("imm_width"),
        MemoryLayout.paddingLayout(3)
    ).withName("cs_systemz_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$368:2"), groupElement("reg"));
    ...
    private static final OfLong imm$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$368:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$368:2"), groupElement("mem"));
    ...
    private static final long access$OFFSET = 32;
    ...
    private static final OfByte imm_width$LAYOUT = (OfByte)$LAYOUT.select(groupElement("imm_width"));
     ...
     * }
     */
    public static final OfByte imm_width$layout() {
        return imm_width$LAYOUT;
    }

    private static final long imm_width$OFFSET = 36;
     ...
     * }
     */
    public static final long imm_width$offset() {
        return imm_width$OFFSET;
    }
     ...
     * }
     */
    public static byte imm_width(MemorySegment struct) {
        return struct.get(imm_width$LAYOUT, imm_width$OFFSET);
    }
     ...
     * }
     */
    public static void imm_width(MemorySegment struct, byte fieldValue) {
        struct.set(imm_width$LAYOUT, imm_width$OFFSET, fieldValue);
    }
