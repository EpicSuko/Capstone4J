...
public class cs_sh_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            sh_op_mem.layout().withName("mem"),
            sh_op_dsp.layout().withName("dsp")
        ).withName("$anon$250:2")
    ).withName("cs_sh_op");
    ...
    private static final OfLong imm$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$250:2"), groupElement("imm"));
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$250:2"), groupElement("reg"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$250:2"), groupElement("mem"));
    ...
    private static final GroupLayout dsp$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$250:2"), groupElement("dsp"));
     ...
     * }
     */
    public static final GroupLayout dsp$layout() {
        return dsp$LAYOUT;
    }

    private static final long dsp$OFFSET = 8;
    ...
    public static MemorySegment dsp(MemorySegment struct) {
        return struct.asSlice(dsp$OFFSET, dsp$LAYOUT.byteSize());
    }
    ...
    public static void dsp(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, dsp$OFFSET, dsp$LAYOUT.byteSize());
    }
