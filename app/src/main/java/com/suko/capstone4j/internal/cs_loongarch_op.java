...
/**
 * {@snippet lang=c :
 * struct cs_loongarch_op {
 *     loongarch_op_type type;
 *     union {
 *         unsigned int reg;
 *         int64_t imm;
 *         loongarch_op_mem mem;
 *     };
 *     uint8_t access;
 * }
 * }
 */
public class cs_loongarch_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            loongarch_op_mem.layout().withName("mem")
        ).withName("$anon$38:2"),
        capstone_h.C_CHAR.withName("access"),
        MemoryLayout.paddingLayout(7)
    ).withName("cs_loongarch_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$38:2"), groupElement("reg"));
    ...
    private static final OfLong imm$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$38:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$38:2"), groupElement("mem"));
    ...
    private static final long access$OFFSET = 24;
