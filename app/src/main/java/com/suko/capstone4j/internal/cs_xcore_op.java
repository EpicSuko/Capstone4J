...
public class cs_xcore_op {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            xcore_op_mem.layout().withName("mem")
        ).withName("$anon$78:2")
    ).withName("cs_xcore_op");
    ...
    private static final OfInt reg$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$78:2"), groupElement("reg"));
    ...
    private static final OfInt imm$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$78:2"), groupElement("imm"));
    ...
    private static final GroupLayout mem$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$78:2"), groupElement("mem"));
