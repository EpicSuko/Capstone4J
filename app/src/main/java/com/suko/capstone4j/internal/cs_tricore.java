 ...
 * struct cs_tricore {
 *     uint8_t op_count;
 *     cs_tricore_op operands[8];
 *     bool update_flags;
 * }
 * }
 */
public class cs_tricore {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(8, cs_tricore_op.layout()).withName("operands"),
    ...
    public static void operands(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, operands(struct, index0), 0L, cs_tricore_op.layout().byteSize());
    }
    ...
    private static final long update_flags$OFFSET = 264;
